...
<footer class="ampstart-footer flex flex-column items-center px3 ">
    ...
    <nav class="ampstart-footer-nav">
        <ul class="list-reset flex flex-wrap mb3">
            <li class="px1"><a class="text-decoration-none ampstart-label" href="https://www.iv-service.ru/about.html">О компании</a></li>
            <li class="px1"><a class="text-decoration-none ampstart-label" href="https://www.iv-service.ru/adress.html">Контакты</a></li>
            <li class="px1"><a class="text-decoration-none ampstart-label" href="https://www.iv-service.ru/cars/bestprice/">Лучшие предложения</a></li>
        </ul>
    </nav>
    <small class="mb4">
        © {site-name}, 2020<br>
