...
<header class="ampstart-headerbar fixed flex justify-start items-center top-0 left-0 right-0 pl2 pr4 ">
    ...
    <div class="ampstart-navbar m-auto">
        NEWS<span style="color: #a80000;">RUSSIA</span>.MEDIA
    </div>
</header>
<!-- Start Sidebar -->
<amp-sidebar id="header-sidebar" class="ampstart-sidebar px3  " layout="nodisplay">
    ...
    <ul class="ampstart-sidebar-faq list-reset m0">
        <li class="ampstart-faq-item"><a href="/about.html" class="text-decoration-none">О сайте</a></li>
        <li class="ampstart-faq-item"><a href="/reklama.html" class="text-decoration-none">Рекламодателям</a></li>
    </ul>
</amp-sidebar>
<!-- End Sidebar -->
<!-- End Navbar -->
