...
<head>
    ...
    {* DLE style *}
    <link href="{THEME}/assets/DLE/css/132/engine.css" rel="stylesheet">
    <link href="{THEME}/assets/DLE/css/custom.css" rel="stylesheet">
...
<body>
    ...
    <script src="{THEME}/assets/DLE/js/libs.js"></script>
    {* {include file="{THEME}/assets/DLE-13.1/js/javascript.tpl"} *}

    {* Переключение цветовой схемы *}
    <script src="{THEME}/assets/DLE/js/styleswitch.js" type="text/javascript"></script>
